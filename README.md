...
Three notebooks, one pipeline:

1. **01 — PMR cleaning + EDA**
2. **02 — Housing cleaning + EDA + bias audit**
3. **03 — Modeling (Random Forest) + embeddings (ModernBERT) + search (FAISS)**

Outputs: 2 models, 3 encoders/scalers, 1 embedding file, 2 FAISS
indexes. 8 files, all verified at export.
...
Requirements: pandas, geopandas, scikit-learn, sentence-transformers, faiss
